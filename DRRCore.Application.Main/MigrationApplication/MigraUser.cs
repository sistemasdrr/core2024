                   ...
                   var inserted= await _companyDomain.AddCompanyAsync(new Company
                    ...
                    if (inserted != 0)
                    {
                        ...
                        foreach (var item in listTraductionCompany)
                        {
                            ...
                            {
                                if (empresa.EmPrensa != null || empresa.EmPrensasel != null)
                                {
                                    item.LargeValue = string.IsNullOrEmpty(empresa.EmPrensa) ? empresa.EmPrensasel : empresa.EmPrensa;
                                }
                            }
                        }
