namespace DRRCore.Application.DTO.Core.Request
{
    public class AddOrUpdateEmployeeRequestDto
    {
        ...
        public List<AddHealthInsuranceRequestDto> HealthInsuranceRequestDto { get; set; } = new List<AddHealthInsuranceRequestDto>();
      
    }
    public class AddHealthInsuranceRequestDto
    {
