...
public partial class MEmpresaC
{
    ...
    public string? EmTipsoc { get; set; }
    ...
    public string? EmRamneg { get; set; }

    public string? EmRamnegIng { get; set; }
    ...
    public string? MorFecha { get; set; }

    public int? MorTotDoc { get; set; }

    public int? MorTotMn { get; set; }

    public int? MorTotMe { get; set; }

    public int? MorTotPag { get; set; }

    public string? MorComent { get; set; }

    public string? MorComentIng { get; set; }

    public string? SbdFecha { get; set; }

    public string? SbdTc { get; set; }

    public int? SbdTotMn { get; set; }

    public int? SbdTotMe { get; set; }

    public int? SbdTotGarMn { get; set; }

    public int? SbdTotGarMe { get; set; }

    public string? SbdComentarios { get; set; }

    public string? SbdComentariosIng { get; set; }
    ...
    public string? MemoSunat { get; set; }
