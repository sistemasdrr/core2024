...
public partial class TEmpresaTipoB
{
    ...
    public string? EmPrftel { get; set; }

    public string? EmTelefo { get; set; }
    ...
    public string? EmVentas { get; set; }

    public string? BaTotact1 { get; set; }

    public string? BaTotpat1 { get; set; }
    ...
    public string EmLogexp { get; set; } = null!;

    public string? BaUtiper { get; set; }
